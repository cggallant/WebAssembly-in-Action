...
The code in the following folder has been updated to work with _Emscripten 2.0.0_: [updated-code](https://github.com/cggallant/WebAssembly-in-Action/tree/master/updated-code)
