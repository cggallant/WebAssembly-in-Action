...
Over the coming days, I'll update the code and push it to the [updated-code](https://github.com/cggallant/WebAssembly-in-Action/tree/master/updated-code) folder.
