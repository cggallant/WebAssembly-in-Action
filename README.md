...
The code in the following folder is being updated to work with _Emscripten 2.0.8_: [updated-code](https://github.com/cggallant/WebAssembly-in-Action/tree/master/updated-code)
