...
// {{PRE_LIBRARY}}
  ...
  var __main_thread_futex_wait_address=8224;function _emscripten_futex_wake(addr, count) {
  ...
  function cleanupThread(pthread_ptr) {
      ...
      if (pthread) {
        ...
        var pthreadMainJs = locateFile('three_pthreads.worker.js');
