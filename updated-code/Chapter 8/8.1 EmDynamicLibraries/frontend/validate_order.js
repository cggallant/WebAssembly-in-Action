...
var Module = typeof ModuleOrder != 'undefined' ? ModuleOrder : {};
...
["_malloc","_free","_atoi","___wasm_apply_data_relocs","_ValidateProduct","_ValidateQuantity","_fflush","onRuntimeInitialized"].forEach((prop) => {
...
var wasmBinaryFile;
  wasmBinaryFile = 'validate_order.wasm';
...
// end include: preamble.js
  ...
  function _IsIdInArray(
  ) {
  if (!wasmImports['IsIdInArray'] || wasmImports['IsIdInArray'].stub) abort("external symbol 'IsIdInArray' is missing. perhaps a side module was not linked in? if this function was expected to arrive from a system library, try to build the MAIN_MODULE with EMCC_FORCE_STDLIBS=1 in the environment");
  return wasmImports['IsIdInArray'].apply(null, arguments);
  }
  _IsIdInArray.stub = true;
  ...
  var ___stack_high = 67248;

  var ___stack_low = 1712;

  var ___stack_pointer = new WebAssembly.Global({'value': 'i32', 'mutable': true}, 67248);
...
/** @type {function(...*):?} */
var _ValidateProduct = Module["_ValidateProduct"] = createExportWrapper("ValidateProduct");
/** @type {function(...*):?} */
var _ValidateQuantity = Module["_ValidateQuantity"] = createExportWrapper("ValidateQuantity");
/** @type {function(...*):?} */
...
function stackCheckInit() {
  ...
  // here.
  _emscripten_stack_set_limits(67248 , 1712);
...
if (typeof exports === 'object' && typeof module === 'object')
  ...
  define([], function() { return ModuleOrder; });
